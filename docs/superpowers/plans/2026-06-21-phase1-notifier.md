...
- 所有路径基于仓库根 `/home/yd/workspace/cc-poke/`。
    ...
    "Notification": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "/home/yd/workspace/cc-poke/.venv/bin/cc-poke-notify"
          }
        ]
      }
    ]
...
Run:
```bash
echo '{"message":"hello from cc-poke smoke test","cwd":"/tmp"}' | /home/yd/workspace/cc-poke/.venv/bin/cc-poke-notify; echo "exit=$?"
```
